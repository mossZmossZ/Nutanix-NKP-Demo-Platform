              ...
              {users.map((u) => (
                ...
                >
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-3">
                      <div className="flex size-10 shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-violet-500 to-purple-600 text-sm font-semibold text-white uppercase shadow-sm">
                        {u.username.charAt(0)}
                      </div>
                      <div>
                  ...
                  <td className="px-6 py-4">
                    <select
                      className="rounded-lg border border-input bg-surface px-3 py-2 text-sm font-medium text-foreground outline-none transition-all hover:border-violet-300 focus-visible:border-primary focus-visible:ring-2 focus-visible:ring-primary/20 disabled:cursor-not-allowed disabled:opacity-50"
                      value={u.role}
