...
This design system draft was generated from Figma and suggests a clear accent color for emphasis, a light and spacious background foundation, strong readable text contrast. It is intended as a working specification for UI generation, design system documentation, and AI-assisted layout exploration. Review semantic tokens and component rules before using it as a final source of truth.

---

## Colors

- Primary (#EFCCBC): Main call-to-action buttons, active highlights, and strong emphasis.
- Background (#FFFFFF): Page background and large canvas areas.
- Surface (#ECECFE): Cards, panels, modals, and elevated containers.
- Text (#020935): Headings, body copy, and primary reading content.
- Border (#D7D4D4): Subtle dividers, input borders, and low-emphasis outlines.
- Muted Text (#5C5F6E): Secondary copy, helper text, and low-emphasis metadata.
- Supporting Color (#651FFF): Secondary or contextual color requiring manual semantic review before reuse as a primary accent.
- Supporting Color (#BDB8B8): Secondary or contextual color requiring manual semantic review before reuse as a primary accent.
- Supporting Color (#F2EEEB): Secondary or contextual color requiring manual semantic review before reuse as a primary accent.
...
### Buttons
- **Primary**: #EFCCBC fill, #FFFFFF text, no border, radius 8px.
- **Primary Hover**: #D7B8A9 fill, #FFFFFF text, no border.
- **Primary Focus**: #EFCCBC fill, #FFFFFF text, 3px ring #EFCCBC1F.
- **Primary Disabled**: #EFCCBC fill, #FFFFFF text, 40% opacity.

- **Secondary**: transparent fill, #020935 text, 1px #D7D4D4 border, radius 8px.
- **Secondary Hover**: #0209350A fill, #020935 text, 1px #D7D4D4 border.
- **Secondary Focus**: transparent fill, #020935 text, 1px #EFCCBC border, 3px ring #EFCCBC1F.
- **Secondary Disabled**: transparent fill, #5C5F6E text, 1px #D7D4D4 border, 40% opacity.

- **Ghost**: transparent fill, #5C5F6E text, no border, radius 8px.
- **Ghost Hover**: #02093506 fill, #020935 text, no border.
- **Ghost Focus**: transparent fill, #020935 text, 3px ring #EFCCBC1F.
- **Ghost Disabled**: transparent fill, #5C5F6E text, no border, 40% opacity.

### Cards
- **Default**: #ECECFE fill, 1px #D7D4D4 border, radius 8px.
- **Elevated**: #ECECFE fill, soft elevation, radius 8px.
- **Large Panel**: #ECECFE fill, subtle border or elevation, radius 8px.

### Inputs
- **Default**: #ECECFE fill, 1px #D7D4D4 border, text color #020935, radius 8px.
- **Hover**: #ECECFE fill, 1px #B0AEAE border, text color #020935.
- **Focus**: #ECECFE fill, 1px #EFCCBC border, 3px ring #EFCCBC1F.
- **Error**: #ECECFE fill, 1px #EF4444 border, 3px ring #EF44441F.
- **Disabled**: #EDEDFE fill, 1px #D7D4D4 border, text color #5C5F6E, 40% opacity.
...
1. **Do** use #EFCCBC for key interactive emphasis only.
2. **Do** keep page backgrounds consistent with #FFFFFF.
3. **Do** preserve strong readability with #020935 for core reading content.
...
- Auto layout containers found: 0
